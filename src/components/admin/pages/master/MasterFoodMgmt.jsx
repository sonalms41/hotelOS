			...
			<div className="admin-boardtype-body">
				<div className="col-wrapper">
					<div className="col-item col-item--lg-3">
						<AdminCardPrimary>
							<h3 className="heading-tertiary">Add Food Item</h3>
					...
					<div className="col-item col-item--lg-9">
						<AdminCardPrimary>
							<h3 className="heading-tertiary">List Food Items</h3>
							<table className="admin-table admin-table--masterlanguage">
								<thead>
									<tr>
										<th className="width-10p">S.N</th>
										<th className="width-20p">Food item</th>
										<th className="width-30p">Deactivated / Activated</th>
										<th className="width-40p text-right">Action</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td className="width-10p">1</td>
										<td className="width-20p">Nepali</td>
