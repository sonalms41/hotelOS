...
import { handlePayWithKhalti } from "../../../../adminUtility/paymentGateway";
...
const AdminReconcilations = (props) => {
	...
	// Reconcile
	const handleRecocile = (amount) => {
		//handlePayWithKhalti(amount, propertyId, userId)
		const postValues = {
				...
				<div className="entry-rec-amount card-primary">
					...
					<div className="admin-form">
						...
						<button
							type="submit"
							className="admin-btn admin-btn--primary"
							onClick={() => handleRecocile(reconcileAmount)}
						>
							Submit
						</button>
					</div>
